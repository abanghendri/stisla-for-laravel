                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills w-100">
                                ...
                                <li class="nav-pill ml-auto">
                                    <a class="nav-link active" href="#" wire:click="add" data-toggle="tooltip"
...
<!-- Modal -->
<div class="modal fade" id="inputModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
...
@section('scripts')
<script src="{{ asset('page/features-posts.js')}}"></script>
@endsection
